	...
	<tbody>
		{#each people as person}
			<tr>
				...
				<td><button type="button" onclick={() => removePerson(person.id)}>Remove</button></td>
			</tr>
...
<form onsubmit={addPerson}>
	<fieldset>
		...
		<label><span>Name</span><input type="text" bind:value={newPerson.name} /></label>
		<label><span>LastName</span><input type="text" bind:value={newPerson.lastname} /></label>
		<label><span>Profession</span><input type="text" bind:value={newPerson.profession} /></label>
